...
function runCase(name: string, runner: (context: CaseContext) => unknown): [string, unknown] {
  const context = setup();
  try {
    return [name, runner(context)];
  } finally {
    teardown(context);
  }
}
...
export function run(): Record<string, unknown> {
  ...
  {
    const [name, result] = runCase('reports-key-mismatch', () => {
  ...
  {
    const [name, result] = runCase('updates-raw-text-instance-id', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('attrs.aligns-ids-and-patches', (context) => {
      function App() {
  ...
  {
    const [name, result] = runCase('attrs.removes-missing', (context) => {
      function App() {
  ...
  {
    const [name, result] = runCase('attrs.adds-background-only', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('attrs.skips-identical', (context) => {
      function App() {
        const props = { id: 'same' };
        return <view {...(props as any)} />;
      }
  ...
  {
    const [name, result] = runCase('attrs.object-value-updates', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('attrs.patches-nested-component', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('attrs.nullish-values', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('attrs.array-diff', (context) => {
      function App() {
        const props = __BACKGROUND__
          ? { ids: [1, 2] }
          : { ids: [1] };
  ...
  {
    const [name, result] = runCase('attrs.style-object-updates', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('attrs.type-diff', (context) => {
      function App() {
        const props = __BACKGROUND__
          ? { id: 123 }
          : { id: '123' };
  ...
  {
    const [name, result] = runCase('attrs.batch-multiple-patches', (context) => {
      function App() {
        const props = __BACKGROUND__
  ...
  {
    const [name, result] = runCase('children.creates-and-inserts-new', (context) => {
      function App() {
        return (
          <view>
  ...
  {
    const [name, result] = runCase('children.removes-missing', (context) => {
      function App() {
        return (
          <view>
  ...
  {
    const [name, result] = runCase('children.reorders-when-order-differs', (context) => {
      function App() {
        return (
          <view>
            {__BACKGROUND__
  ...
  {
    const [name, result] = runCase('children.reuses-by-type-ignoring-keys', (context) => {
      function App() {
  ...
  {
    const [name, result] = runCase('children.mixed-operations', (context) => {
      function App() {
        return (
          <view>
            {__BACKGROUND__
  ...
  {
    const [name, result] = runCase('children.inserts-before-existing-sibling', (context) => {
      function App() {
        return (
          <view>
            {__BACKGROUND__
  ...
  {
    const [name, result] = runCase('children.missing-slot-record-on-main', (context) => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.missing-slot-record-on-background', (context) => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.creates-missing-nodes-recursively', (context) => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.moves-before-existing-sibling', (context) => {
      function App() {
        return (
          <view>
            {__BACKGROUND__
  ...
  {
    const [name, result] = runCase('children.non-string-raw-text-key-on-main', (context) => {
      function App() {
        return (
          <view>
  ...
  {
    const [name, result] = runCase('children.raw-text-instance-empty-text', (context) => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('coverage.raw-text-key-branches', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.iterates-existing-slots', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.skips-duplicate-create-emission', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('children.missing-attrs-element', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('coverage.move-before-child', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
  ...
  {
    const [name, result] = runCase('coverage.emit-create-raw-text', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
      resetGlobalCommitContext();
  ...
  {
    const [name, result] = runCase('coverage.emit-create-raw-text-non-text', () => {
      backgroundElementTemplateInstanceManager.clear();
      backgroundElementTemplateInstanceManager.nextId = 0;
      resetGlobalCommitContext();
  ...
  {
    const [name, result] = runCase('complex-trees.deeply-nested-dynamic-content', (context) => {
  ...
  {
    const [name, result] = runCase('full-flow.dispatches-update-event', (context) => {
